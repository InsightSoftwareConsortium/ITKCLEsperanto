...
#ifndef itkCLEInPlaceImageFilter_h
#define itkCLEInPlaceImageFilter_h

#include "itkInPlaceImageFilter.h"
#include "itkCLEImageToImageFilter.h"
...
class ITK_TEMPLATE_EXPORT CLEInPlaceImageFilter
  : public CLEImageToImageFilter<TInputImage, TOutputImage, TParentImageFilter>
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(CLEInPlaceImageFilter);
...
protected:
  CLEInPlaceImageFilter();
  ~CLEInPlaceImageFilter() override;
...
#  include "itkCLEInPlaceImageFilter.hxx"
#endif
