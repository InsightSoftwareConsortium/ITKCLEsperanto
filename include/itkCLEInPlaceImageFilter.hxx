 ...
 *
 *=========================================================================*/
#ifndef itkCLEInPlaceImageFilter_hxx
#define itkCLEInPlaceImageFilter_hxx


namespace itk
{
template <typename TInputImage, typename TOutputImage, typename TParentImageFilter>
CLEInPlaceImageFilter<TInputImage, TOutputImage, TParentImageFilter>::CLEInPlaceImageFilter() = default;
...
template <typename TInputImage, typename TOutputImage, typename TParentImageFilter>
void
CLEInPlaceImageFilter<TInputImage, TOutputImage, TParentImageFilter>::ReleaseInputs()
{
  CPUSuperclass::ReleaseInputs();
  /*
    if( this->GetCLEEnabled() )
    {
      // do something
      std::cout << "ToDo: CLEInPlaceImageFilter::ReleaseInputs()" << std::endl;
    }
    else
    {
      CPUSuperclass::ReleaseInputs();
...
template <typename TInputImage, typename TOutputImage, typename TParentImageFilter>
void
CLEInPlaceImageFilter<TInputImage, TOutputImage, TParentImageFilter>::AllocateOutputs()
{
  if (this->GetCLEEnabled())
  {
